...
params.lowpass = 40; % Hz, used for constructing a bpfilter used for both the audio and the eeg
...
subjects = dir([basedir filesep 'exg' filesep 'raw' filesep 'S*.mat']);
subjects = sort({subjects(:).name});
postfix = '_dry.mat';


for subject = subjects
    load(fullfile(basedir,'exg','raw',subject{1}))
    preproc_trials = {};
