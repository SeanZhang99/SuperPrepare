...
for dataset_name = dataset_names
    ...
    switch dataset_name
        ...
        case "PKU_preprocessed"
            base_path = fullfile(raw_path,"PKU-4talker-EEG","preprocessed_data","data_space");
            audio_path = "";
            fs = 128;
            ...
            num_speaker = 4;
        case "PKU-NBD_preprocessed"
            base_path = fullfile(raw_path,"PKU-4talker-NBD-EEG","ScalpEEG","preprocess_data","data_space");
            audio_path = "";
            fs = 128;
            filelists = dir(fullfile(base_path, "sub*","*cap.mat"));
            channel_indices = 1:59;
        ...
        case "ICL_preprocessed"
            base_path = fullfile(raw_path,"ICL","preprocessed");
            audio_path = "";
            fs = 128;
        ...
        case "CocktailParty_preprocessed"
            base_path = fullfile(raw_path,"CocktailParty","sphg");
            audio_path = "";
            fs = 128;
            filelists = dir(fullfile(base_path,"*.mat"));
            channel_indices = 1:64;
        ...
        case "USTC_preprocessed"
            base_path = fullfile(raw_path,"USTC","superhuge");
            audio_path = fullfile(raw_path,"USTC","Audio");
            fs = 128;
            filelists = dir(fullfile(base_path,"*.mat"));
            channel_indices = 1:64;
            f_upper = 64;
            num_trial = 20;
            desired_length = 15360;
            num_speaker = 2;
            channel = ["FP1","FPZ","FP2","AF3","AF4","F7","F5","F3","F1",...
                "FZ","F2","F4","F6","F8","FT7","FC5","FC3","FC1","FCZ",...
                "FC2","FC4","FC6","FT8","T7","C5","C3","C1","CZ","C2",...
                "C4","C6","T8","M1","TP7","CP5","CP3","CP1","CPZ","CP2",...
                "CP4","CP6","TP8","M2","P7","P5","P3","P1","PZ","P2",...
